...
<body>
	<form action="epub_update.ada" method="post">
		<input type="hidden" name="sourtnum" value="1">
		<s:hidden name="epub.id"></s:hidden>
		<table>
			<tr>
				<td>电子书名</td>
				<td><s:textfield name="epub.name" /></td>
			</tr>
			<tr>
				<td>分类名</td>
				<td><s:select list="categorys" listKey="id" listValue="title"
						name="epub.categoryid" headerKey="0" headerValue="无"></s:select>
				</td>
			</tr>
			<tr>
				<td>上传图片</td>
				<td><s:textfield name="epub.picurl" id="picurl" /> <input
					type="button" id="insertfile" value="选择文件" /></td>
			</tr>
			<tr>
				<td>图片</td>
				<td><img alt=""  height="150" src="<s:property value="epub.picurl" />" id="picurlimg"></td>
			</tr>
			<tr>
				<td>上传电子书</td>
				<td><s:textfield name="epub.fileurl" id="fileurl" /><input
					type="button" id="insertfileurl" value="选择文件" /></td>
			</tr>
			<tr>
				<td>描述</td>
				<td><textarea name="epub.description"
						style="width: 600px; height: 400px;">
						<s:property value="epub.description" />
					</textarea></td>
			</tr>
			<tr>
				<td><input type="reset" />
