...
<body>
 <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
          <tr>
            <td  height="27" align="center" background="<%=path%>/project/img/cat_bg.gif">序号</td>
			...
			<s:if test="pageResult.resultList!=null">
				...
				<s:iterator value="#alllist" status="st">
					<tr onmouseover="this.style.backgroundColor='#BDDFFF'"
						...
						<td align="center" bgcolor="#FFFFFF"><img alt="" width="40" height="40" src="<s:property value="picurl"/>">
						</td>
					 ...
					 <td align="center"  class="tou"  colspan="5">											
							  ...
							  <s:if test="pageResult!=null&&pageResult.resultList!=null">
					           ...
					           (每页<s:property value="pageResult.pageBean.pageSize"/>条)&nbsp;&nbsp;
					                ...
					                <s:else>
					                  <a href="<s:url value="epub_list.ada">
